...
from tensorpack.dataflow import (
    BatchData, MultiThreadMapData, DataFromList, RepeatedData)
...
def get_val_dataflow(
    ...
    if num_splits is None:
        ...
        files = dataset.ILSVRC12Files(datadir, dataname, shuffle=False)
        files.reset_state()
...
class ImageNetModel(ModelDesc):
    ...
    def image_preprocess1(self, image):
        """Note that there could be a bug in original code, and we replace it by the next function, It functions normally then"""
