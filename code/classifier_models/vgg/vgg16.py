...
class Vgg16:
    def __init__(self, vgg16_npy_path=None, pooling = None):
    ...
    def build(self, rgb):
        ...
        self.lwp = get_current_layer_wrapper()
        self.conv1_1 = self.conv_layer(bgr, "conv1_1")

        self.conv1_2 = self.conv_layer(self.conv1_1, "conv1_2")
        self.lwp.record_by_id(self.conv_prev_relu, 0)
        self.pool1 = self.pool(self.conv1_2, 'pool1')

        self.conv2_1 = self.conv_layer(self.pool1, "conv2_1")
        
        self.conv2_2 = self.conv_layer(self.conv2_1, "conv2_2")
        self.lwp.record_by_id(self.conv_prev_relu, 1)
        ...
        self.lwp.record_by_id(self.conv_prev_relu, 2)
        ...
        self.lwp.record_by_id(self.conv_prev_relu, 3)
        ...
        self.lwp.record_by_id(self.conv_prev_relu, 4)
